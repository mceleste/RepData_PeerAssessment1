...
The median number of steps taken per day with missing values is: `r median.steps`.
...
The mean number of steps taken per day Without missing values is: `r avg.new.steps`.

The median number of steps taken per day without missing values is: `r med.new.steps`.
